# SPDX-FileCopyrightText: 2024-2026, Jakob Bornecrantz.
...
VERSIONS=(21 20 19 18 17 16 15 14 13 12 11 11 10)
FILES=(
"Analysis.h"
"BitReader.h"
"BitWriter.h"
...
# Copy top of tree.
# do_the_copy "21" <- If we want to copy the dev version uncomment.
